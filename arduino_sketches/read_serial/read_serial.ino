...
/*
 DEPRECATED: The old read_serial sketch has been superseded by
 `arduino_sketches/nano_controller/nano_controller.ino`. Keep this file only for
 reference. Delete it to remove confusion.
*/
